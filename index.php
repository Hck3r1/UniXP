        ...
        <section id="features" class="section features-area style-two overflow-hidden ptb_100">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div style="margin-left: 380px" class="col-12 col-md-6 col-lg-4">
                        <!-- Image Box -->
                        <div class="image-box text-center icon-1 p-5 wow fadeInRight" data-wow-delay="0.4s">
                            <!-- Featured Image -->
                            <div class="featured-img mb-3">
                            ...
                            <div class="team-thumb d-inline-block position-relative overflow-hidden">
                                ...
                                <div class="team-overlay">
                                    ...
                                    <div class="team-icons">
                                        <a class="p-2" href="#"><i class="fab fa-github"></i></a>
                        ...
                        <div class="single-team text-center overflow-hidden m-2 m-lg-0">
                            ...
                            <div class="team-thumb d-inline-block position-relative overflow-hidden">
                                ...
                                <div class="team-overlay">
                                    ...
                                    <!-- Team Icons -->
                                    <div class="team-icons">
                                        <a class="p-2" href="https://github.com/Hck3r1"><i class="fab fa-github"></i></a>
                                        <a class="p-2" href="https://twitter.com/_hck3rrr"><i class="fab fa-twitter"></i></a>
                                        <a class="p-2" href="https://www.linkedin.com/in/oluwaferanmi-idima-3967951b2/"><i class="fab fa-linkedin-in"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-team text-center overflow-hidden m-2 m-lg-0">
                            ...
                            <div class="team-thumb d-inline-block position-relative overflow-hidden">
                                ...
                                <div class="team-overlay">
                                    ...
                                    <!-- Team Icons -->
                                    <div class="team-icons">
                                        <a class="p-2" href="https://github.com/gokethecreator"><i class="fab fa-github"></i></a>
                                        <a class="p-2" href="https://twitter.com/nifemiii__"><i class="fab fa-twitter"></i></a>
